# Código con todas las opciones de programación (2do orden)
function [T] = difFinitas_estacionario(xnode, model, cb, ct)
  ...
  F = zeros(length(xnode),1);

  for n = 1:length(xnode):  # For que recorre el tiempo
